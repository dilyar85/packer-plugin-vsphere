...
- A new release will be coming soon to publish the customized VM as a new VM image.
...
Please check the [examples/supervisor folder](https://github.com/hashicorp/packer-plugin-vsphere/tree/main/builder/vsphere/examples/supervisor) for more complete examples.
